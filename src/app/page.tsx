...
export default function ABNLanding() {
  return (
    <div className="min-h-screen bg-[#F5F3EE] text-[#1A1A1A]">
      ...
      <header className="sticky top-0 z-50 bg-[#F5F3EE]/90 backdrop-blur-lg border-b border-[#1A1A1A]/5">
        <nav className="font-sans px-6 md:px-12 py-5 flex justify-between items-center max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <Image src="/logos/abn-frame-lockup-light.svg" alt="Agencia Bir Nuñez" width={220} height={40} className="hidden md:block h-10 w-auto hover:opacity-80 transition-opacity duration-200" />
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#casos" className="text-sm font-medium hover:text-[#C7A54A] transition-colors hidden md:block">
              Casos
            </a>
            <a href="#equipo" className="text-sm font-medium hover:text-[#C7A54A] transition-colors hidden md:block">
              Equipo
            </a>
            <a
              href="#contacto"
              className="text-sm font-medium bg-[#1A1A1A] text-[#F5F3EE] px-4 py-2 rounded-sm hover:bg-[#1A1A1A]/90 transition-colors hidden md:block"
            >
              Hablemos
            </a>
          </div>
          ...
          <div className="max-w-4xl fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="btn-primary font-sans inline-flex items-center justify-center gap-2 bg-[#F5F3EE] text-[#1A1A1A] px-6 py-3 rounded-sm font-medium hover:bg-white"
              >
              ...
              <a
                href="#divisiones"
                className="btn-outline font-sans inline-flex items-center justify-center gap-2 text-sm font-medium border-2 border-[#F5F3EE]/30 text-[#F5F3EE] px-6 py-3 rounded-sm hover:bg-[#F5F3EE] hover:text-[#1A1A1A]"
              >
                Conocer divisiones
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 text-center relative">
            <div className="proof-card">
              <p className="font-sans font-bold text-3xl md:text-4xl text-[#1A1A1A]">2</p>
              <p className="font-sans text-sm text-[#1A1A1A]/60 mt-1">Sistemas propios en producción</p>
            </div>
            <div className="proof-card">
              <p className="font-sans font-bold text-3xl md:text-4xl text-[#1A1A1A]">20+</p>
              <p className="font-sans text-sm text-[#1A1A1A]/60 mt-1">Años de experiencia institucional</p>
            </div>
            <div className="proof-card">
              <p className="font-sans font-bold text-3xl md:text-4xl text-[#1A1A1A]">4</p>
              <p className="font-sans text-sm text-[#1A1A1A]/60 mt-1">Divisiones bajo un mismo equipo</p>
            </div>
            <div className="proof-card">
              <p className="font-sans font-bold text-3xl md:text-4xl text-[#C7A54A]">2/2</p>
              <p className="font-sans text-sm text-[#1A1A1A]/60 mt-1">Sistemas propios en uso interno</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 md:px-12 py-24 md:py-32 bg-[#1A1A1A] text-[#F5F3EE] overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="scroll-reveal-left">
              ...
              <h2 className="font-sans font-bold text-3xl md:text-4xl leading-tight mb-6">
                ...
                <span className="text-[#C7A54A]">¿Quién define el estándar?</span>
              </h2>
              <p className="font-sans text-[#F5F3EE]/70 leading-relaxed mb-8">
              ...
              <div className="space-y-5 mb-8">
                <div className="flex items-start gap-4">
                  <span className="font-sans font-bold text-4xl text-[#C7A54A]/20 leading-none shrink-0 mt-0.5">01</span>
                  <div>
                    <p className="font-sans font-medium text-sm">La institución configura su estándar</p>
                    <p className="font-sans text-xs text-[#F5F3EE]/50">Capacidades MEC + contexto local + filosofía pedagógica del colegio</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="font-sans font-bold text-4xl text-[#C7A54A]/20 leading-none shrink-0 mt-0.5">02</span>
                  <div>
                    <p className="font-sans font-medium text-sm">La IA genera planes y 6 materiales por semana</p>
                    <p className="font-sans text-xs text-[#F5F3EE]/50">Texto base, ficha, evaluación, comunicado, guía, y rúbrica — alineados al estándar</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="font-sans font-bold text-4xl text-[#C7A54A]/20 leading-none shrink-0 mt-0.5">03</span>
                  <div>
                    <p className="font-sans font-medium text-sm">El docente revisa, ajusta, imprime</p>
                    <p className="font-sans text-xs text-[#F5F3EE]/50">DOCX y PDF listos — el docente aporta su criterio, no su fin de semana</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                {['Texto base', 'Ficha de trabajo', 'Evaluación', 'Comunicación a padres', 'Guía de cuaderno', 'Rúbrica'].map((tag) => (
                  <span
                    key={tag}
                    className="capability-tag font-sans text-xs px-3 py-1.5 bg-[#F5F3EE]/10 rounded-sm text-[#F5F3EE]/70 border border-[#F5F3EE]/10 cursor-default"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <div className="scroll-reveal-right">
              ...
              <p className="font-sans text-xs text-[#F5F3EE]/30 mt-4 text-center">
      ...
      <section id="divisiones" className="px-6 md:px-12 py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto scroll-reveal">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Technology Division */}
            <div className="card-hover bg-[#1A1A1A] text-[#F5F3EE] p-8 md:p-10 rounded-sm">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-[#F5F3EE] rounded-sm flex items-center justify-center">
                  <svg className="w-6 h-6 text-[#1A1A1A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                  </svg>
                </div>
                <div>
                  <p className="font-sans text-xs tracking-widest text-[#C7A54A] uppercase">División</p>
                  <h3 className="font-sans font-semibold text-2xl">Sistemas & Tecnología</h3>
                </div>
              </div>
              <p className="font-sans text-sm text-[#F5F3EE]/60 mb-4">Director: Anthony Bir</p>
              <p className="font-sans text-[#F5F3EE]/70 leading-relaxed mb-6">
              ...
              <ul className="font-sans text-sm space-y-2 text-[#F5F3EE]/60">
            ...
            {/* Education Division */}
            <div className="card-hover bg-[#F5F3EE] p-8 md:p-10 rounded-sm border border-[#1A1A1A]/10">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-[#1A1A1A] rounded-sm flex items-center justify-center">
              ...
              <p className="font-sans text-sm text-[#1A1A1A]/60 mb-4">Directora: Diana Nuñez de Bir</p>
              <p className="font-sans text-[#1A1A1A]/70 leading-relaxed mb-6">
              ...
              <ul className="font-sans text-sm space-y-2 text-[#1A1A1A]/60">
            ...
            <div className="card-hover bg-[#F5F3EE] p-8 md:p-10 rounded-sm border border-[#1A1A1A]/10">
              ...
              <p className="font-sans text-sm text-[#1A1A1A]/60 mb-4">Directora: Danae Bir Nuñez</p>
              <p className="font-sans text-[#1A1A1A]/70 leading-relaxed mb-6">
            ...
            <div className="card-hover bg-[#F5F3EE] p-8 md:p-10 rounded-sm border border-[#1A1A1A]/10">
              ...
              <p className="font-sans text-sm text-[#1A1A1A]/60 mb-4">Directora: Stephanie Bir</p>
              <p className="font-sans text-[#1A1A1A]/70 leading-relaxed mb-6">
      ...
      {/* Cases / Social Proof */}
      <section id="casos" className="px-6 md:px-12 py-24 md:py-32 bg-[#F5F3EE]">
        <div className="max-w-7xl mx-auto scroll-reveal">
          <div className="mb-16">
            <p className="font-sans text-sm tracking-widest text-[#C7A54A] mb-4 uppercase">
              Casos Reales
          ...
          <div className="space-y-20">
              ...
              <div className="scroll-reveal-left">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-12 h-12 stat-card rounded-sm flex items-center justify-center">
                    <span className="text-[#F5F3EE] font-sans font-semibold text-xl">A</span>
                  </div>
                  <div>
                    <h3 className="font-sans font-semibold text-xl">AENA Admin</h3>
                    <p className="font-sans text-sm text-[#1A1A1A]/60">Sistema de Gestión Escolar</p>
                  </div>
                </div>
                <p className="font-sans text-[#1A1A1A]/70 leading-relaxed mb-6">
                ...
                <ul className="font-sans text-sm space-y-2 text-[#1A1A1A]/60">
                  <li className="flex items-center gap-2">
                    <svg className="w-4 h-4 text-[#C7A54A] shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="#contacto" className="inline-flex items-center gap-1 font-sans text-sm font-medium text-[#C7A54A] mt-6 hover:underline">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className="md:order-2">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-12 h-12 stat-card rounded-sm flex items-center justify-center">
                    <span className="text-[#F5F3EE] font-sans font-semibold text-xl">I</span>
                  </div>
                  <div>
                    <h3 className="font-sans font-semibold text-xl">IPUPY Tesorería</h3>
                    <p className="font-sans text-sm text-[#1A1A1A]/60">Sistema de Gestión Financiera</p>
                  </div>
                </div>
                <p className="font-sans text-[#1A1A1A]/70 leading-relaxed mb-6">
      ...
      <section className="px-6 md:px-12 py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto scroll-reveal">
          <div className="mb-16">
            ...
            <p className="font-sans text-[#1A1A1A]/70 leading-relaxed max-w-3xl mt-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="card-hover engagement-card bg-[#F5F3EE] p-8 rounded-sm border border-[#1A1A1A]/10">
              <p className="engagement-step">01</p>
              <h3 className="font-sans font-semibold text-xl mb-2">Diagnóstico Institucional</h3>
              <p className="font-sans text-sm text-[#C7A54A] mb-4">Para colegios, ONGs e iglesias que necesitan ordenar primero</p>
              <p className="font-sans text-[#1A1A1A]/70 leading-relaxed mb-6">
            ...
            <div className="card-hover engagement-card bg-[#F5F3EE] p-8 rounded-sm border-2 border-[#C7A54A]/40 relative">
              <span className="absolute top-0 right-0 bg-[#C7A54A] text-[#F5F3EE] font-sans text-[0.65rem] tracking-widest uppercase px-3 py-1 rounded-bl-sm">Más común</span>
              <p className="engagement-step">02</p>
              <h3 className="font-sans font-semibold text-xl mb-2">Implementación por Frente</h3>
              <p className="font-sans text-sm text-[#C7A54A] mb-4">Para instituciones que ya saben qué problema quieren resolver</p>
              <p className="font-sans text-[#1A1A1A]/70 leading-relaxed mb-6">
            ...
            <div className="card-hover engagement-card bg-[#F5F3EE] p-8 rounded-sm border border-[#1A1A1A]/10">
              ...
              <p className="font-sans text-sm text-[#C7A54A] mb-4">Para instituciones que necesitan ejecución continua y coordinación central</p>
              <p className="font-sans text-[#1A1A1A]/70 leading-relaxed mb-6">
      ...
      {/* Philosophy */}
      <section className="px-6 md:px-12 py-24 md:py-32 bg-[#1A1A1A] text-[#F5F3EE]">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            <div>
              <p className="font-sans text-sm tracking-widest text-[#C7A54A] mb-6 uppercase">
                Nuestra Filosofía
              </p>
              <h2 className="font-sans font-bold text-3xl md:text-4xl leading-tight mb-6">
                Sistemas que controlan la IA — no al revés
              </h2>
              <p className="font-sans text-[#F5F3EE]/70 leading-relaxed">
            ...
            <div className="space-y-6">
              <div className="border-l-2 border-[#C7A54A] pl-6">
                ...
                <p className="font-sans text-sm text-[#F5F3EE]/60">
      ...
      {/* Team */}
      <section id="equipo" className="px-6 md:px-12 py-24 md:py-32 bg-[#F5F3EE]">
        <div className="max-w-7xl mx-auto scroll-reveal">
          <div className="mb-16">
            <p className="font-sans text-sm tracking-widest text-[#C7A54A] mb-4 uppercase">
              Quiénes Somos
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-start mb-16">
            <div className="font-sans text-[#1A1A1A]/70 leading-relaxed space-y-4">
              <p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-[#1A1A1A] rounded-sm flex items-center justify-center mx-auto mb-4 team-avatar">
                <span className="text-[#F5F3EE] font-sans font-semibold text-2xl">AB</span>
              </div>
              <h3 className="font-sans font-semibold text-lg">Anthony Bir</h3>
              <p className="font-sans text-sm text-[#1A1A1A]/60">Director General & Sistemas</p>
              <p className="font-sans text-xs text-[#1A1A1A]/40 mt-1">Ex-Heinz, Thermo Fisher. Arquitecto de AENA Admin e IPUPY.</p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-[#1A1A1A] rounded-sm flex items-center justify-center mx-auto mb-4 team-avatar">
                <span className="text-[#F5F3EE] font-sans font-semibold text-2xl">DN</span>
              </div>
              <h3 className="font-sans font-semibold text-lg">Diana Nuñez de Bir</h3>
              <p className="font-sans text-sm text-[#1A1A1A]/60">Directora de Educación</p>
              <p className="font-sans text-xs text-[#1A1A1A]/40 mt-1">20+ años en educación. Diseña la línea pedagógica institucional.</p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-[#1A1A1A] rounded-sm flex items-center justify-center mx-auto mb-4 team-avatar">
                <span className="text-[#F5F3EE] font-sans font-semibold text-2xl">DB</span>
              </div>
              <h3 className="font-sans font-semibold text-lg">Danae Bir Nuñez</h3>
              <p className="font-sans text-sm text-[#1A1A1A]/60">Directora Legal</p>
              <p className="font-sans text-xs text-[#1A1A1A]/40 mt-1">Especialista en derecho de niñez y protocolos institucionales.</p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-[#1A1A1A] rounded-sm flex items-center justify-center mx-auto mb-4 team-avatar">
                <span className="text-[#F5F3EE] font-sans font-semibold text-2xl">SB</span>
              </div>
              <h3 className="font-sans font-semibold text-lg">Stephanie Bir</h3>
              <p className="font-sans text-sm text-[#1A1A1A]/60">Directora Financiera</p>
              <p className="font-sans text-xs text-[#1A1A1A]/40 mt-1">Gestión financiera y auditoría para ONGs e instituciones educativas.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 md:px-12 py-16 bg-[#E8E6E1] border-y border-[#1A1A1A]/10">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="font-sans text-[#1A1A1A]/70 mb-6 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="btn-primary font-sans inline-flex items-center justify-center gap-2 bg-[#1A1A1A] text-[#F5F3EE] px-8 py-4 rounded-sm font-medium hover:bg-[#1A1A1A]/90"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" />
              </svg>
            ...
            <a
              href="#contacto"
              className="btn-outline font-sans inline-flex items-center justify-center gap-2 text-sm font-medium border-2 border-[#1A1A1A] px-8 py-4 rounded-sm hover:bg-[#1A1A1A] hover:text-[#F5F3EE]"
            >
              Enviar mensaje
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 md:gap-20">
            <div>
              ...
              <p className="font-sans text-[#1A1A1A]/70 leading-relaxed mt-12">
              ...
              <div className="mt-8 font-sans text-sm text-[#1A1A1A]/60">
      ...
      <footer className="bg-[#1A1A1A] text-[#F5F3EE]">
        ...
        <div className="px-6 md:px-12 py-8 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <p className="font-sans text-sm text-[#F5F3EE]/40">
